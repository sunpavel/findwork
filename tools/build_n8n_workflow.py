...
EXPERTISE_CARD = (
    ...
    "- CCO федеральной сети TERMOLAND (B2C): рост с 3 до 15 объектов, +40% чек, +50% поток, медиабюджет >5 млн/мес, подписная модель, CRM-воронка, AI-инструменты.\n"
    "- CCO IT-стартапа Rukki.pro (B2B): отдел продаж с нуля, выполнение плана продаж на 100% при ограниченном ассортименте, контракты с Топ-5 застройщиков, резидент Skolkovo.\n"
...
LLM_PROMPT = (
    "=Ты — Executive Career Advisor и нанимающий руководитель уровня Korn Ferry, Ward Howell, "
    "Spencer Stuart, Egon Zehnder. Оцени, насколько вакансия подходит КОНКРЕТНОМУ кандидату по его "
    "реальному опыту и УРОВНЮ, а не по совпадению слов. Сначала определи РЕАЛЬНУЮ задачу/боль бизнеса "
    "за текстом вакансии (что компании нужно решить), потом — решал ли кандидат похожее.\n\n"
    "КАНДИДАТ (источник правды о его опыте):\n" + EXPERTISE_CARD + "\n\n"
    "КРИТЕРИИ (думай по сути):\n"
    "0. Боль бизнеса: какую задачу реально закрывает роль и есть ли у кандидата опыт её решения.\n"
    ...
    "глава направления, вице-президент) = «в уровень». Руководитель/начальник ОТДЕЛА (РОП, "
    "руководитель отдела продаж/маркетинга), руководитель группы, тимлид, старший/рядовой "
    ...
    '{"fit_score":0-100,"level_match":"ниже|в уровень|выше","why":"1-2 предложения: какую боль бизнеса '
    'закрывает его опыт, с конкретикой","gaps":["чего не хватает / на что смотреть"],'
